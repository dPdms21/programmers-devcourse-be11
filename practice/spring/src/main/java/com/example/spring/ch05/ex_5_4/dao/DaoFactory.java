...
import com.example.spring.ch05.ex_5_4.service.*;
...
public class DaoFactory {
    ...
    // * 메일 발송 구현을 여기서 결정 (추상화의 교체 지점)
    // - 지금은 실제 SMTP 서버가 없으므로 DummyMailSender(아무것도 안 함)를 꽂음
    // - 운영에서는 JavaMail 기반 실제 발송 구현으로 '이 한 줄만' 바꾸면 됨
    //   UserServiceImpl 코드는 전혀 손대지 않음
    @Bean
