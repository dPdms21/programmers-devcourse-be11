...
// 권한 테스트 API 호출. 권한이 없으면 서버가 403 + {status, message} JSON을 내려줌
...
let renderUserInfo = (user) => {
    ...
    // (숨겨도 URL 직접 입력으로 들어갈 수는 있지만, 그 경우 admin.js가 API 403을 받고 쫓아냄
    //  — UI 숨김은 편의일 뿐, 실제 보안은 항상 서버(@PreAuthorize)가 담당)
